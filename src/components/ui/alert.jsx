    ...
    variants: {
      variant: {
        ...
        destructive:
          ...
          success: 
          "border-green-500 text-green dark:border-green-500 opacity-100 [&>svg]:text-green-500 dark:border-green-900 dark:text-green-900 dark:border-green-900 dark:[&>svg]:text-green"
